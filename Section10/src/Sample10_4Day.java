...
public class Sample10_4Day {
	...
	public static String relation(Sample10_4Day d1, Sample10_4Day d2) {
	...
	//-- コンストラクタ --//
	public Sample10_4Day() {}
	public Sample10_4Day(int year) {
		this.year = year;
		}
	public Sample10_4Day(int year, int month) {
		this(year);
		if(month <= 0) this.month = 1;
		else if(month >= 13) this.month = 12;
		else this.month = month;
		}
	public Sample10_4Day(int year, int month, int date) {
		this(year, month);
	...
	public Sample10_4Day(Sample10_4Day d) {this(d.year, d.month, d.date);}
	...
	//--- 日付dと正しいか ---//
	public boolean equalTo(Sample10_4Day d) {
	...
	public String relation(Sample10_4Day d) {

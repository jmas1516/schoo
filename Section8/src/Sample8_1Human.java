// 人間クラス
public class Sample8_1Human {
	private String name;    //名前
	private int grade;      //学年
	private int record;     //成績
	private int gender;     //性別 0:女 1:男
	private double height;  //身長
	private Sample9_2Day birthday; // 誕生日

	//--- コンストラクタ ---//
	Sample8_1Human(String name, int grade, int gender, double height, Sample9_2Day birthday){
		this.name = name; this.grade = grade;
		this.record = -1; this.gender = gender; this.height = height;
		this.birthday = new Sample9_2Day(birthday);
	}
	//--- ゲッタ ---//
	...
	public Sample9_2Day getBirthday() {return birthday;}
	...
	public void toString() {
		System.out.pritnf("氏名：%s\n学年：%d年\n性別：%s\n身長：%fcm\n生年月日：" + birthday + "\n", name, grade, (gender == 0 ? "女" : "男"), height);
	}
}
